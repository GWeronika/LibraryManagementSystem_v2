...
public class AccountController {
    ...
    public boolean updateAccountPassword(Long accountID, String password) {
        return accountService.updateAccountPassword(accountID, password);
    }

    @GetMapping("/update/password/byemail")
    public boolean updateAccountPassword(String email, String password) {
        return accountService.updateAccountPassword(email, password);
    }
